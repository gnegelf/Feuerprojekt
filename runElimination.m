...
if eliminate 
    ...
    b_Ufull=[b_U;b_Uext];
    b_Lfull=[b_L;b_Lext];
    save('~/python/feuerData16_50.mat','A','Aext','b_Uext','b_Lext','xn','tn','intVarN','contVarN','b_U','b_L','c','Afull','b_Ufull','b_Lfull')
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %count=100000;
    ...
    x_k=x_k';
    plup=A*x_k;
    sum(plup<=b_L-0.00001)
    sum(plup>=b_U+0.00001)
    fI=find(plup>b_U+0.001);
    %x_k=Result.x_k;
    x_kEli=x_k;
    plotVideo
else
